...
class LlamaRunner(Runner):
    ...
    def load_model(self, model_name, n_gpu_layers):
        ...
        cache = LlamaCache()
        self.llm = Llama(model_path=model_name, n_gpu_layers=n_gpu_layers, verbose=True, logits_all=True, n_threads=0)
...
model_params = {
    ...
    'llama-7B': ('llama', 'models/llama-7B/llama-7b.ggmlv3.q8_0.bin', 1000),
    ...
    'llama-7B-huggingface': ('huggingface', 'jeffwan/llama-7b-hf', 0),
    'bert-tiny-uncased': ('huggingface', 'google/bert_uncased_L-2_H-128_A-2', 0),
}

# client = OpenAI(
#     # defaults to os.environ.get("OPENAI_API_KEY")
#     api_key="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",
